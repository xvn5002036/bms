...
?>
<b><font style="filter: glow(color=#006600,strength=3); height:10px; color:white; padding:1px">
<div align="center">≡Top <?php echo $Top5; ?> 玩家名聲排行榜≡</b></br></br>
<table cellpadding="1">
<tr>
    ...
    <td width="80" height="20"><span class="content"><div align="center"><font style="filter: glow(color=#0066ff,strength=3); height:10px; color:white; padding:1px">名聲</font></div></span></td>
</tr>
...
?>
	<tr>
	    ...
	    <td><span class="content"><div align="center"><font style="color:white;filter: glow(color=#006600,strength=3); height:10px; color:white; padding:1px)"><?php echo round($data['fame']/1,0); ?></div></span></td>
	</tr>
<?php
}
//close table
