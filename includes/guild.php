...
$query = mysql_query("SELECT * FROM `guildS` ORDER BY `GP` DESC ");
...
?>
<b><font style="filter: glow(color=#9933ff,strength=3); height:10px; color:white; padding:1px">
<div align="center">≡Top <?php echo $Top5; ?> 公會積分排行榜≡</b></br></br>
<table cellpadding="1">
<tr>
	...
	<td height="20" width="80"><span class="content"><div align="center"><font style="filter: glow(color=#0066ff,strength=3); height:10px; color:white; padding:1px">工會暱稱</font></div></span></td>
    ...
    <td width="80" height="20"><span class="content"><div align="center"><font style="filter: glow(color=#0066ff,strength=3); height:10px; color:white; padding:1px">GP</font></div></span></td>
</tr>
...
?>
	<tr>
	    ...
	    <td><span class="content"><div align="center"><font style="color:white;filter: glow(color=#006600,strength=3); height:10px; color:white; padding:1px)"><?php echo round($data['guild']/1,0); ?></div></span></td>
	</tr>
<?php
}
//close table
