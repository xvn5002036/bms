...
if($realpass == hash('sha512',$password.$salt) && $accountid == $id && $meso >=10000000) {
     mysql_query("UPDATE characters SET fame = fame + 100 WHERE name = '$char' LIMIT 1");
...
?>
<!-- start content -->
       <div align="center"> <div class='welcome'><br>歡迎來到名聲交易中心!</br>
<br>1000萬遊戲幣可換取100點名聲!</br> 
<br>請務必確認您已經退出遊戲</br> 
...
?>
              ...
              <form id="form1" name="form1" method="post" action="">
                  ...
                  <tr>
                        ...
                        <tr>
                          <td align="right" colspan="2"><input id="reset" name="reset" type="submit" value="兌換名聲" /></td>
                        </tr>
                    </table>
            </form>
            </div>
